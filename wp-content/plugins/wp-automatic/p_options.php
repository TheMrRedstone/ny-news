					...
					<div class="postbox " id="dashboard_right_now">
							...
							<div class="postbox " id="dashboard_right_now">
								...
								<div class="inside TTWForm main" style="padding-bottom: 14px">
									...
									<div class="field f_100 ">
										<label>APIFY API token</label> <input value="<?php   echo get_option( 'wp_automatic_apify_key' ) ?>" name="wp_automatic_apify_key" type="text">
										<div class="description">Check <a href="http://valvepress.com/how-to-get-a-deepl-api-authentication-key/" target="_blank">this tutorial</a> on how to get your API token</div>
									</div>
