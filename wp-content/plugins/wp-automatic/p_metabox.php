 		 		 		...
 		 		 		<?php  $i++ ; } ?>
			                        ...
			                        <div>
						               ...
						               <div class="option clearfix">
						                 ...
						                 <div class="option clearfix">
								                    <input name="camp_options[]"   value="OPT_FEED_APIFY3" type="checkbox">
								                    <span class="option-title">
															Load the site single posts using APIFY.COM (only if this site requires JavaScript)
								                    </span>
								                    <br>
								             </div>
							               ...
							               <div class="option clearfix">
								                    ...
								                    <span class="option-title">
															Load the site pages using APIFY.COM (only if this site requires JavaScript)
								                    </span>
								                    <br>
								             </div>
